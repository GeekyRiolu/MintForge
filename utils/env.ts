...
export function getEnv(name: Doppler): any {
  ...
  case Doppler.NEXT_PUBLIC_FACEBOOK_PIXEL_ID: return process.env.NEXT_PUBLIC_FACEBOOK_PIXEL_ID;
  ...
  case Doppler.NEXT_PUBLIC_HP_V3_ENABLED: return process.env.NEXT_PUBLIC_HP_V3_ENABLED;
  ...
  case Doppler.NEXT_PUBLIC_OFFCHAIN_ASSOCIATION_ENABLED: return process.env.NEXT_PUBLIC_OFFCHAIN_ASSOCIATION_ENABLED;
  ...
  case Doppler.NEXT_PUBLIC_REACT_WINDOW_ENABLED: return process.env.NEXT_PUBLIC_REACT_WINDOW_ENABLED;
  ...
  case Doppler.NEXT_PUBLIC_SOCIAL_ENABLED: return process.env.NEXT_PUBLIC_SOCIAL_ENABLED;
