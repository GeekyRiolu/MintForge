...
export interface Profile_auctionInterface extends utils.Interface {
  functions: {
    "cancelledOrFinalized(bytes32)": FunctionFragment;
    "contract2()": FunctionFragment;
    "extendFeesAddress()": FunctionFragment;
    ...
    "mintFeesAddress()": FunctionFragment;
    ...
    "setExtendFeeAddress(address)": FunctionFragment;
    ...
    "setMintFeesAddress(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "extendFeesAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mintFeesAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setExtendFeeAddress",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMintFeesAddress",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface Profile_auction extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Profile_auctionInterface;
  ...
  functions: {
    ...
    extendFeesAddress(overrides?: CallOverrides): Promise<[string]>;
    ...
    mintFeesAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    extendFeesAddress(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    mintFeesAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    extendFeesAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    mintFeesAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
