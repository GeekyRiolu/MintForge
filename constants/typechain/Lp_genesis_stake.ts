...
export declare namespace LpStake {
...
export interface Lp_genesis_stakeInterface extends utils.Interface {
  functions: {
...
export interface Lp_genesis_stake extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Lp_genesis_stakeInterface;
  ...
  callStatic: {
    ...
    updatePool(
      pid: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<LpStake.PoolInfoStructOutput>;
