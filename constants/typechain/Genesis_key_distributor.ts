...
export interface Genesis_key_distributorInterface extends utils.Interface {
  functions: {
...
export interface Genesis_key_distributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Genesis_key_distributorInterface;
