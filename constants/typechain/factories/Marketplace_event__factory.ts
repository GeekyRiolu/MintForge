...
export class Marketplace_event__factory {
  static readonly abi = _abi;
  static createInterface(): Marketplace_eventInterface {
    return new utils.Interface(_abi) as Marketplace_eventInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Marketplace_event {
    return new Contract(address, _abi, signerOrProvider) as Marketplace_event;
  }
}
