...
import type { X2y2_exchange, X2y2_exchangeInterface } from "../X2y2_exchange";
...
export class X2y2_exchange__factory {
  static readonly abi = _abi;
  static createInterface(): X2y2_exchangeInterface {
    return new utils.Interface(_abi) as X2y2_exchangeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): X2y2_exchange {
    return new Contract(address, _abi, signerOrProvider) as X2y2_exchange;
  }
}
