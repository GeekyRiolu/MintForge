...
import type { Genesis_key, Genesis_keyInterface } from "../Genesis_key";
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256",
        name: "quantityToClaim",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "quantityToTreasury",
        type: "uint256",
      },
    ],
    name: "mintLeftOver",
...
export class Genesis_key__factory {
  static readonly abi = _abi;
  static createInterface(): Genesis_keyInterface {
    return new utils.Interface(_abi) as Genesis_keyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Genesis_key {
    return new Contract(address, _abi, signerOrProvider) as Genesis_key;
  }
}
