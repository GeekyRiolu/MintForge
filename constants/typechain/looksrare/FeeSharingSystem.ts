...
export interface FeeSharingSystemInterface extends utils.Interface {
  functions: {
...
export type NewRewardPeriodEvent = TypedEvent<
  [BigNumber, BigNumber, BigNumber],
  NewRewardPeriodEventObject
>;
...
export interface FeeSharingSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeSharingSystemInterface;
