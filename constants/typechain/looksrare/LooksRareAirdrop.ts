...
export interface LooksRareAirdropInterface extends utils.Interface {
  functions: {
...
export interface LooksRareAirdrop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LooksRareAirdropInterface;
