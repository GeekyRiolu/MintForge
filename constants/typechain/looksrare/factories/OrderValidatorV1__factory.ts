...
import type {
  OrderValidatorV1,
  OrderValidatorV1Interface,
} from "../OrderValidatorV1";
...
export class OrderValidatorV1__factory {
  static readonly abi = _abi;
  static createInterface(): OrderValidatorV1Interface {
    return new utils.Interface(_abi) as OrderValidatorV1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OrderValidatorV1 {
    return new Contract(address, _abi, signerOrProvider) as OrderValidatorV1;
  }
}
