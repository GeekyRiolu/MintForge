...
import type {
  LooksRareAirdrop,
  LooksRareAirdropInterface,
} from "../LooksRareAirdrop";
...
export class LooksRareAirdrop__factory {
  static readonly abi = _abi;
  static createInterface(): LooksRareAirdropInterface {
    return new utils.Interface(_abi) as LooksRareAirdropInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LooksRareAirdrop {
    return new Contract(address, _abi, signerOrProvider) as LooksRareAirdrop;
  }
}
