...
import type {
  ...
  AggregatorFeeSharingWithUniswapV3Interface,
} from "../AggregatorFeeSharingWithUniswapV3";
...
export class AggregatorFeeSharingWithUniswapV3__factory {
  static readonly abi = _abi;
  static createInterface(): AggregatorFeeSharingWithUniswapV3Interface {
    return new utils.Interface(
      _abi
    ) as AggregatorFeeSharingWithUniswapV3Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as AggregatorFeeSharingWithUniswapV3;
  }
}
