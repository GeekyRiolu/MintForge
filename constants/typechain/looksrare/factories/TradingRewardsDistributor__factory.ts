...
import type {
  ...
  TradingRewardsDistributorInterface,
} from "../TradingRewardsDistributor";
...
export class TradingRewardsDistributor__factory {
  static readonly abi = _abi;
  static createInterface(): TradingRewardsDistributorInterface {
    return new utils.Interface(_abi) as TradingRewardsDistributorInterface;
  }
  static connect(
    address: string,
