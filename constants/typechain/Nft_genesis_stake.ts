...
export interface Nft_genesis_stakeInterface extends utils.Interface {
  functions: {
...
export interface Nft_genesis_stake extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Nft_genesis_stakeInterface;
  ...
  functions: {
    ...
    collectTokens(
      _xNftAmount: PromiseOrValue<BigNumberish>,
